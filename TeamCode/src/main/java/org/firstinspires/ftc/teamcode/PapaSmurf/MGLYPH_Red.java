 ...
 */
@Autonomous(name = "MGlyph_Red", group = "LinearOpMode")
public class MGLYPH_Red extends LinearOpMode {
...
//            } while (((sensors.getDistanceL()) > 68.5 + 1 || sensors.getDistanceL() < 68.5 - 1) && (runtime.seconds() < 100) && sensors.getDistanceL() != 0 && !isStopRequested());
        ...
        if (vu == 3) {
            ...
            while ( Math.abs(sensors.getDistanceR() - 85) > .5 && (runtime.seconds() < 5) && sensors.getDistanceR() != 0 && !isStopRequested())
            {
                if (Math.abs(sensors.getDistanceR() - 85) > 6)
                    pVal = .03;
                power = (sensors.getDistanceR() - 85) * -pVal;
...
//            } while (((sensors.getDistanceL()) > 68.5 + 1 || sensors.getDistanceL() < 68.5 - 1) && (runtime.seconds() < 100) && sensors.getDistanceL() != 0 && !isStopRequested());
        ...
        if (vu == 3) {
            ...
            while ( Math.abs(sensors.getDistanceL() - 85) > .5 && (runtime.seconds() < 5) && sensors.getDistanceL() != 0 && !isStopRequested())
            {
                power = (sensors.getDistanceL() - 85) * -.03;
